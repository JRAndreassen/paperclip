...
pub trait Nodes: Clone + Send + Sync {
    ...
    async fn get_nodes(&self, ) -> Result<ResponseContent<Vec<crate::models::Node>>, Error<crate::models::RestJsonError>>;
...
pub mod direct {
    ...
    pub trait Nodes: Clone + Send + Sync {
        ...
        async fn get_nodes(&self, ) -> Result<Vec<crate::models::Node>, super::Error<crate::models::RestJsonError>>;
...
impl direct::Nodes for NodesClient {
    ...
    async fn get_nodes(&self, ) -> Result<Vec<crate::models::Node>, Error<crate::models::RestJsonError>> {
    
        Nodes::get_nodes(self, ).await.map(|r| r.into_body())
    }
